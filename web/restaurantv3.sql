...
insert  into `pedido`(`id`,`fecha`,`estado`,`id_mesa`,`id_usuario`) values (1,'24/02/2016','1',1,1),(2,'24/02/2016','1',2,1);
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `increment_id_pedido_mes` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `increment_id_pedido_mes` BEFORE INSERT ON `pedido_mesa` FOR EACH ROW SET NEW.id = (SELECT MAX(id) + 1 FROM pedido_mesa) */$$
