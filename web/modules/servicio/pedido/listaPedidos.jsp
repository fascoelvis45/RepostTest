                ...
                <div class="box-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td> 
                                <button type="button" class="btn btn-success btn-lg btn-block" onclick="cargarURL('pedido/formEditPedido.jsp?id_pedido=<%=rs.getObject("id")%>&id_usuario=<%=id_usuario%>', 'content')"><b>    <i class="fa fa-plus"></i> PRODUCTO</b></button>

                                <% if (total != 0) {%>
                                <button type="button" class="btn btn-danger btn-lg btn-block" onclick="cargarURL('pedido/liberarMesa.jsp?id_pedido=<%=rs.getObject("id")%>&id_usuario=<%=id_usuario%>', 'content')"><b>    <i class="fa fa-minus"></i> LIBERAR MESA</b></button>
                                <%} else {%>
                                <button type="button" class="btn btn-danger btn-lg btn-block" onclick="cargarURL('pedido/deletePedido.jsp?id_pedido=<%=rs.getObject("id")%>&id_usuario=<%=id_usuario%>', 'content')"><b>    <i class="fa fa-minus"></i> LIBERAR MESA</b></button> 
                                <%}%>
