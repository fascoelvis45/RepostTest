            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    ...
                    <div class="btn-group pull-right">
                        ...
                        <button type="button" class="btn btn-info" onclick="cargarURL('pedido/listaPedidos.jsp?id_usuario=<%=id_usuario%>', 'content')">PENDIENTES</button> 
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        int numFil =0;
                            SQL = "SELECT *   FROM pedido "
                                    + " where  id_usuario = '" + id_usuario + "' and estado  in ('0','2')     ";
                        ...
                        <tr>
                            ...
                            <td> 
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th colspan="3" style="text-align:center; ">MESA :
                                              <%
                            ...
                            <td> 
                                ...
                                <% if (rs.getObject("estado").equals("2")) {%>

                                <button class="btn btn-info btn-lg btn-block" onclick="cargarURL('boleta/formBoleta.jsp?id_pedido=<%=rs.getObject("id")%>', 'content')">
                                    <b>    
                                        <!--<i class="fa fa-plus" ></i>-->
                                        BOLETA VENTA</b>
                                </button>

                                <button class="btn btn-success btn-lg btn-block" onclick="cargarURL('factura/formFactura.jsp?id_pedido=<%=rs.getObject("id")%>', 'content')">
                                    <b> 
                                        <!--<i class="fa fa-plus" ></i>--> 
                                        FACTURA</b>
                                </button>
                                ...
                                <button class="btn btn-default btn-lg btn-block" onclick="cargarURL('ticket/formTicket.jsp?id_pedido=<%=rs.getObject("id")%>', 'content')">
