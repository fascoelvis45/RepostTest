                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <div class="box-body">
                                    ...
                                    <input type="hidden" class="form-control" id="serie" name="serie" value="F001" />
                                    <input type="hidden"   id="id_usuario" name="id_usuario" value="<%=id_usuario%>" />
                                </div>
                                <div class="box-footer">

                                    <button type="submit" class="btn btn-info btn-lg btn-block">GENERAR FACTURA</button>
                                </div>
...
<script type="text/javascript">
    ...
    frm.submit(function (ev) {
        ...
        $.ajax({
            type: 'POST',
            url: 'factura/imprimirFactura.jsp',
            data: frm.serialize(),
