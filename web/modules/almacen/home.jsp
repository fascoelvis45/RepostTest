            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="#" onclick="cargarURL('pedido/listaPedidos.jsp?id_usuario=<%=id_usuario%>','content')" >
                                <i class="fa fa-th"></i> <span>PEDIDOS - CAJA</span>  
                            </a>
                        </li>

                        <li>
                            <a href="#" onclick="">
                                <i class="fa fa-calendar"></i> <span>REPORTE VENTAS</span>
